...
class PetController extends Controller
{
    ...
    public function uploadForm(int $id): View|RedirectResponse
    {
        try {
            $pet = $this->petService->find($id);
        } catch (PetstoreException $e) {
        ...
        return view('pets.upload', compact('pet'));
    }

    public function uploadImage(UploadPetImageRequest $request, int $id): RedirectResponse
    {
        try {
            $this->petService->uploadImage($id, $request);
        } catch (PetstoreException $e) {
            return back()->withInput()->with('error', $this->friendlyError($e));
        }
